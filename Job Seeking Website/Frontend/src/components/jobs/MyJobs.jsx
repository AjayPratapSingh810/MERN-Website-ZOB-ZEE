...
const MyJobs = () => {
        ...
        const fetchJobs = async () => {
            try {
                const { data } = await axios.get(
                    "http://localhost:5000/api/jobs/getmyjobs",
    ...
    const handleUpdateJob = async (jobId) => {
        ...
        await axios
            .put(`http://localhost:5000/api/jobs/update/${jobId}`, updatedJob, {
                withCredentials: true,
            })
            .then((res) => {
    ...
    const handleDeleteJob = async (jobId) => {
        await axios
            .delete(`http://localhost:5000/api/jobs/delete/${jobId}`, {
                withCredentials: true,
            })
            .then((res) => {
                toast.success(res.data.message);
                    ...
                    {myJobs.length > 0 ? (
                        <>
                            <div className="banner">
                                {myJobs.map((element) => (
                                    <div className="myJobs-card" key={element._id}>
